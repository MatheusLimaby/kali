    ...
    <ScrollView>
      <View style={styles.formato}>
        ...
        <Text style={styles.textoNormal}>
          Neymar da Silva Santos Júnior (Mogi das Cruzes, 5 de fevereiro de 1992) é um futebolista
          brasileiro que atua como atacante. Atualmente, joga pelo Santos.
        </Text>

        <Text style={styles.textoNormal}>
          Infância e juventude: Filho do mecânico Neymar da Silva Santos (de quem herdou o nome)
          e Nadine Santos, Neymar nasceu na cidade de Mogi das Cruzes, na Região Metropolitana de
          São Paulo, em 5 de fevereiro de 1992. Em 2003, aos 11 anos de idade, chegou às categorias
          de base do Santos.
        </Text>

        <Text style={styles.textoNormal}>
          Quando Neymar ainda não ganhava o suficiente para sustentar a família, ele, o pai, a mãe
          e a irmã moravam em um cômodo na casa da avó, na periferia de São Vicente. Aos 17 anos,
          Neymar virou titular no time principal do Santos e seus primeiros patrocínios começaram a
          aparecer.
        </Text>
